            ...
            <div className="container card-shadow content mb-5 mt-4 rounded-4">
                <div className="d-flex justify-content-between px-4 pt-4">
                    ...
                    <div className="col-6 text-end">
                        <button type="button" class="btn btn-success px-5 py-2 rounded-3 m-1" data-bs-toggle="modal" data-bs-target="#createProduct" data-bs-dismiss="modal">
                ...
                <div className="col-md-12 d-flex flex-column">
                    <div className="rounded-4 p-4">
                        <div id="productsGrid" className="ag-theme-alpine" style={{ height: '75vh', width: '100%' }}></div>
                    </div>
                </div>
            </div>
