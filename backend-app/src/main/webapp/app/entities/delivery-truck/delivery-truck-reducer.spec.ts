...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_DELIVERYTRUCK_LIST actions', async () => {
    ...
    it('dispatches FETCH_DELIVERYTRUCK actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_DELIVERYTRUCK actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_DELIVERYTRUCK actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_DELIVERYTRUCK actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_DELIVERYTRUCK actions', async () => {
      const expectedActions = [
        {
