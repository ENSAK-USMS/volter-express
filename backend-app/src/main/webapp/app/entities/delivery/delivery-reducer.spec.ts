...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './delivery.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_DELIVERY_LIST actions', async () => {
    ...
    it('dispatches FETCH_DELIVERY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_DELIVERY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_DELIVERY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_DELIVERY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_DELIVERY actions', async () => {
      const expectedActions = [
        {
