...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './receiver.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_RECEIVER_LIST actions', async () => {
    ...
    it('dispatches FETCH_RECEIVER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_RECEIVER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_RECEIVER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_RECEIVER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_RECEIVER actions', async () => {
      const expectedActions = [
        {
