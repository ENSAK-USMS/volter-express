...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_DELIVERYROUTE_LIST actions', async () => {
    ...
    it('dispatches FETCH_DELIVERYROUTE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_DELIVERYROUTE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_DELIVERYROUTE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_DELIVERYROUTE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_DELIVERYROUTE actions', async () => {
      const expectedActions = [
        {
